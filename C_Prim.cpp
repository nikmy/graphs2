...
class Graph : public IGraph
{
 ...
 public:
    Graph(size_t n_vertices, bool is_directed)
        : IGraph(n_vertices, is_directed), adj_lists_(n_vertices), edge_ends_() {}
...
Weight MSTWeightPrim(const WeightedGraph& g) {
    Weight mst_weight = 0;
    std::priority_queue<WeightedEdgeData,
                        std::vector<WeightedEdgeData>,
                        std::greater<WeightedEdgeData>> queue;
...
int main() {
    ...
    auto g = graph::WeightedGraph(n_vertices, false);
